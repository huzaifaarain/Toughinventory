                 ...
                 <input type="hidden" name="id" value="<?php echo $row->id; ?>">
                    <div class="control-group">
                      <label class="control-label">Supplier</label>
                         <div class="controls">
                                    <select name="supplier_id" class="span6 chzn-select" data-placeholder="Choose a Category" tabindex="1">
                                        ...
                                        {
                                          $attr = ($supplier->id == $row->supplier_id ? " selected='selected' " : null);
                                         ?>
                      ...
                      <label class="control-label">PO Reference(Optional)</label>
                        <div class="controls">
                          <input type="text" name="reference_po" value="<?php echo $row->reference_po; ?>" data-placement="right" 
                    ...
                    <div class="control-group">
                      <label class="control-label">Date</label>
                        <div class="controls">
                          <input type="date" name="date" value="<?php echo $row->date; ?>" class="input-xlarge" required/>
                          <!-- <span class="help-inline">Some hint here</span> -->
                      </div>
                    </div>
                     <div class="control-group">
                      <label class="control-label">Amount</label>
                        <div class="controls">
                          <input type="text" name="amount" value="<?php echo $row->amount; ?>" data-placement="right" 
