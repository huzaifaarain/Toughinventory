...
<div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
               <input type="hidden" id="purchase_id" value="<?php echo $row->id;?>">
               <div class="row-fluid">
                 <div class="span6">
                 ...
                 <div class="widget green">
                   ...
                   <div class="widget-body">
                      <table class="table table-striped table-bordered table-advance table-hover">
                       ...
                       <tbody id="tbody">
                       <?php $items = $this->dbo->viewReturnItem(array('purchase_id'=>$row->id)); 
                   ...
                   <table class="table">
                     ...
                     <tr>
                       ...
                       <div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                        <input id="discount_amount" value="<?php echo $row->total_tax;?>" onchange="calculate();" type="number"><span class="add-on">%</span>
                                    </div>
                                </div>
...
<script type="text/javascript">
  ...
  function addInventory (name,id,cost,size) {
    ...
    if(check == -1)
    {
      ...
      html += "<td><input type='number' data-size='"+size+"' class='calculateQuantity' value='0' onchange='calculate();' id='item_quantity_"+id+"'></td>";
  ...
  $("#btn-Submit").click(function(event) {
    ...
    if (date.length < 1 || length < 1) 
      ...
      $.ajax({
        url: '<?php echo site_url("purchase/savePReturn"); ?>',
        type: 'POST',
        dataType: 'json',
        data: {"sRow": singleRow , "mRow" : multiRowsValues , 'recordid' : purchase_id },
      })
      .done(function(data) {
       $(".loader").hide();
        if (data.result == true) 
...
// End of ready
  ...
  function calculate () 
  {
    ...
    $("#disc_value").text(Math.round(discount_value));
    $("#total_amount").val(Math.round(total_amount));
    $("#total_payble").val(Math.round(net_Total));
  }
