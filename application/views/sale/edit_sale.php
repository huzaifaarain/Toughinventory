                 ...
                 <div class="widget green">
                   ...
                   <div class="widget-body">
                      <table class="table table-striped table-bordered table-advance table-hover">
                       ...
                       <tbody id="tbody">
                       <?php $items = $this->dbo->viewSaleItems(array('sale_id'=>$row->id)); 
                       foreach ($items->result() as $item) 
                       {
                          ...
                          <tr>
                            ...
                            <td><input type='number' value='<?php echo $item->scheme; ?>' onchange='calculate();' ></td>
                            <td><input type='number' value='<?php echo $item->comission; ?>' onchange='calculate();' ></td>
...
<script type="text/javascript">
  ...
  function addInventory (name,id,price,size) {
    ...
    if(check == -1)
    {
      ...
      html += "<td><input type='number' value='"+price+"' onchange='calculate();' ></td>";
      html += "<td><input type='number' value='0' onchange='calculate();' ></td>";
      html += "<td><input type='number' value='0' onchange='calculate();' ></td>";
      html += "<td></td>";
  ...
  $("#btn-Submit").click(function(event) {
    ...
    $(".loader").show();
    var sale_id = $("#id").val();
    var customer_id , reference_no , date , note , tax;
    ...
    if (date.length < 1 || length < 1) 
      ...
      $.ajax({
        url: '<?php echo site_url("sale/saveSale"); ?>',
        type: 'POST',
        dataType: 'json',
