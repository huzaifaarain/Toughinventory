...
<div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
               <div class="span12">
               <input type="hidden" id="id" value="<?php echo $this->dbo->autoID('sales'); ?>">
               <div class="row-fluid">
                 <div class="span6">
                 ...
                 <div class="span6">
                   <div class="control-group">
                      <label class="control-label">Reference(Optional)</label>
                        <div class="controls">
                          <input type="text" id="reference_no" data-placement="right" 
                 ...
                 <div class="span6">
                    <div class="control-group">
                      <label class="control-label">Date</label>
                        <div class="controls">
                          <input type="date" id="date" class="input-xlarge" />
                          <!-- <span class="help-inline">Some hint here</span> -->
                      </div>
                    </div>
                 </div>
                   ...
                   <table class="table">
                     ...
                     <tr>
                       ...
                       <div class="control-group">
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                        <input id="discount_amount" onchange="calculate();" type="number"><span class="add-on">%</span>
                                    </div>
                                </div>
